...
# Network Parameters
n_hidden_1 = 1800  # 1st layer number of neurons
n_hidden_2 = 1800  # 2nd layer number of neurons
...
x_train, x_test, y_train, y_test = train_test_split(subtrain, labels, test_size=0.1, random_state=42)

x_train = np.array(x_train, dtype=np.float)
x_train = x_train.__div__(255.0)
x_test = x_test.__div__(255.0)

y_train = y_train.__add__(-1)
y_test = y_test.__add__(-1)
